...
module SYS_TOP_dft # ( parameter DATA_WIDTH = 8 ,  RF_ADDR = 4 , NUM_OF_CHAINS = 4)
...
FIFO_TOP #(.DATA_WIDTH(DATA_WIDTH)) U0_UART_FIFO (
.W_CLK(REF_CLK_M),
.W_RST(REF_RST_M),  
.W_INC(UART_TX_VLD),
.WR_DATA(UART_TX_IN),             
